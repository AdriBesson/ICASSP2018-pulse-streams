...
filenameOut = strcat(['results_', num2str(n_cha_prior+1) ,'channels_noisy_synth_pulse.mat']);
save(filenameOut, 'nmse', 'nrmse', 'Nt', 'n_points', 'snr_awgn', 'n_draws', 'f0', 'fs', 'c0', 'pulse', 'meas_ratio');